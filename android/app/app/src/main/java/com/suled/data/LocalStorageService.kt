...
class LocalStorageService(private val provider: LocalStorageProvider) {
    ...
    fun getCachedTournament(tournamentId: String): TournamentData? {
        return try {
            ...
            val duration = now - cachedAt
            val hoursSinceCached = duration.inWholeHours
    ...
    fun getNextGame(): NextGameInfo? {
        ...
        val duration = scheduledTime - now
        val minutesUntilStart = (duration.inWholeSeconds / 60).toInt()
